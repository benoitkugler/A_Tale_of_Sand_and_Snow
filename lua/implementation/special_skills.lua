...
function SPECIAL_SKILLS.leeches_cac(lvl, unit)
    ...
    local value = DB.SPECIAL_SKILLS.vranken.leeches_cac(lvl)
    local desc =
        string.format(
...
function SPECIAL_SKILLS.drain_cac(lvl, unit)
    ...
    local values = DB.SPECIAL_SKILLS.vranken.drain_cac(lvl)
...
function SPECIAL_SKILLS.atk_brut(lvl, unit)
    ...
    local ratio = DB.SPECIAL_SKILLS.vranken.atk_brut(lvl)
...
function SPECIAL_SKILLS.def_muspell(lvl, unit)
    ...
    local value = DB.SPECIAL_SKILLS.brinx.def_muspell(lvl)
    local desc =
...
function SPECIAL_SKILLS.dmg_muspell(lvl, unit)
    ...
    local value = DB.SPECIAL_SKILLS.brinx.dmg_muspell(lvl)
...
function SPECIAL_SKILLS.fresh_blood_musp(lvl, unit)
    ...
    local value = DB.SPECIAL_SKILLS.brinx.fresh_blood_musp(lvl)
...
function SPECIAL_SKILLS.muspell_rage(lvl, unit)
    ...
    local value = DB.SPECIAL_SKILLS.brinx.muspell_rage(lvl)
...
function SPECIAL_SKILLS.wave_dmg(lvl, unit)
    ...
    local values = DB.SPECIAL_SKILLS.drumar.wave_dmg(lvl)
...
function SPECIAL_SKILLS.forecast_defense(lvl, unit)
    ...
    local def = DB.SPECIAL_SKILLS.drumar.forecast_defense(lvl)
    unit:add_modification(
        "object",
        {
            id = id,
...
function SPECIAL_SKILLS.slow_zone(lvl, unit)
    ...
    local intensity = DB.SPECIAL_SKILLS.drumar.slow_zone(lvl)
...
function SPECIAL_SKILLS.bonus_cold_mistress(lvl, unit)
    ...
    local values = DB.SPECIAL_SKILLS.drumar.bonus_cold_mistress(lvl)
