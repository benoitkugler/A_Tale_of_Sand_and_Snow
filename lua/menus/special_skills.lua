                ...
                T.grid {
                    ...
                    T.row {
                        T.column {
                            ...
                            T.grid {
                                T.row {
                                    T.column {T.label {id = "text_xp_dispo", label = "test7789"}},
                                            ...
                                            T.grid {
                                                T.row {
                                                    ...
                                                    T.column {
                                                        grow_factor = 1,
                                                        horizontal_grow = true,
                                                        T.label {id = "text_comp", characters_per_line = 50}
                                                    }
                                                }
                                            }
                                        }
...
function MCS.preshow(unit)
    ...
    function MCS.init()
            ...
            if MCS.u_lvl >= v.require_lvl then
                if not v.require_avancement or (table_skills(unit)[v.require_avancement.id] ~= nil) then
                    ...
                    wesnoth.set_dialog_value(
                        "<span style='italic'>" .. v.require_avancement.des .. "</span>",
                        "lcomp",
                        i,
                        "text_comp"
                    )
                ...
                wesnoth.set_dialog_value(
                    _ "<span style='italic'>Require level " .. v.require_lvl .. "</span>",
                    "lcomp",
                    i,
                    "text_comp"
                )
        ...
        wesnoth.set_dialog_value(
            _ " <span font_style='italic' ><span color ='#BFA63F'  >Points available :  </span><span font_weight ='bold' >" ..
                MCS.xp_dispo .. "</span></span>",
            "text_xp_dispo"
        )
        wesnoth.set_dialog_value(
            _ " <span font_style='italic'  color ='#BFA63F'  >Total points:  " .. MCS.xp_total .. "</span>",
            "text_xp_total"
        )
    end
    ...
    local function show_help()
        if MI.skills_help then
            ...
            wesnoth.set_dialog_value(
                MCS.skills_table.help_des .. "\n<span style='italic'>" .. MCS.skills_table.help_ratios .. "</span>",
                "help"
            )
