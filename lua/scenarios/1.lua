...
function ES.explo_mur()
	...
	wesnoth.fire(
		"message",
		{speaker = "jod", message = _ "In the name of Powers ! Their naphtha just destroyed our walls..."}
	)

	wesnoth.fire(
		"message",
		{speaker = "rand", message = _ "Nice job soldiers, the gate is ours ! Go ahead, for Muspell !"}
	)
end
