...
info["brinx"] = {
	...
	},
	{
		...
		{
			cout_suivant = 100,
			des = _ "If a muspellian is at his sides, Brinx will take and deal |10%| bonus damage against all enemies "
		},
		{
			cout_suivant = 0,
			des = _ "If a muspellian is at his sides, Brinx will take and deal |20%| bonus damage against all enemies "
		}
	}
}
...
function apply.dmg_muspell(lvl, unit)
	wesnoth.add_modification(
		unit,
		"object",
		{no_write = true, {"effect", {apply_to = "attack", remove_specials = "dmg_muspell" .. tostring(lvl - 1)}}}
	)
	wesnoth.add_modification(
		unit,
		"object",
		{
			no_write = true,
			{"effect", {apply_to = "remove_ability", {"abilities", {{"isHere", {id = "dmg_muspell" .. tostring(lvl - 1)}}}}}}
		}
	)
...
function apply.fresh_blood_musp(lvl, unit)
	wesnoth.add_modification(
		...
		"object",
		{
			...
			{
				"effect",
				{apply_to = "remove_ability", {"abilities", {{"isHere", {id = "fresh_blood_musp" .. tostring(lvl - 1)}}}}}
			}
		}
	)
...
function apply.muspell_rage(lvl, unit)
	wesnoth.add_modification(
		unit,
		"object",
		{no_write = true, {"effect", {apply_to = "attack", remove_specials = "muspell_rage" .. tostring(lvl - 1)}}}
	)
	wesnoth.add_modification(
		unit,
		"object",
		{
			no_write = true,
			{"effect", {apply_to = "remove_ability", {"abilities", {{"isHere", {id = "muspell_rage" .. tostring(lvl - 1)}}}}}}
		}
	)
